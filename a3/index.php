...
<head>
  ...
  <meta name="description" content="Website dedicated to Douglas Raymond Baker">
  <meta name="author" content="Alexander John Bishara">
  <title>ANZAC Douglas Raymond Baker - Letters Home By Alexander John Bishara s3865348</title>
  <link rel="icon" href="imgs/anzac_logo.jpg" type="image/x-icon"> 
...
<body>
  ...
  <main>
    ...
    <article id=Places>
      ...
      <div class ="section-white" style="text-align: center;">
        ...
        <p>Please click on the link below to view a tour I have compiled highlighting the journey that Douglas has travelled on!
          <br>
          <a href="https://tinyurl.com/DouglasBakerANZAC"> Click here for the tour</a>
          <br>
          <a href="#top">Back to top of page</a>
        </p>
      </div>
    ...
    <article id=Links>
      ...
      <div style="position:relative;">
        <div class ="section-black" style="text-align: center;">
          <p>External Links relating to the ANZAC story</p>
          <p>
            <a href="http://recordsearch.naa.gov.au/scripts/Imagine.asp?B=3009496" rel="nofollow">His complete original service record (Note: this is 20 pages long.)</a>
            <br>
  ...
  <footer style="text-align: center;">
    <div> Content copyright Ian Baker 
    <br> 
    Email : ibak6837@bigpond.net.au 
    </div>
    <div>&copy;<script>document.write(new Date().getFullYear());</script> Alexander John Bishara, s3865348
    <br> 
    <a href="https://github.com/s3865348/wp"> Alexander John Bishara Github Repository</a>
